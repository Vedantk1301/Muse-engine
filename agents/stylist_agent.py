...
class StylistAgent:
    ...
    def _greeting_response(self) -> str:
        ...
        if name:
            return (
                f"{emoji} Hey {name}! Welcome back! "
                f"I'm Muse, your AI fashion stylist. I help you find the perfect outfits by searching our catalog, "
                f"understanding your style, and suggesting complete looks for any occasion. "
                f"What are you shopping for today?"
            )
        else:
            return (
                f"{emoji} Hi! I'm Muse, your AI fashion stylist. "
                f"I help you discover outfits by searching our curated catalog, building travel-ready looks with weather insights, "
                f"matching colors and patterns, and suggesting complete outfits for any occasion. "
                f"Before we start, what's your name?"
            )
